...
object FoodData {
    val foodList = listOf(
        FoodItem(
            ...
            R.drawable.explore,
            "Breakfast",
            listOf("flour", "white sugar", "baking powder", "teaspoon baking soda", "salt", "milk", "large eggs", "butter"),
            listOf("Optional: chocolate chips, blueberries, or sliced bananas for toppings", "vegetable oil"),
    ...
    **Instructions for making pancakes:**
    ...
    """.trimIndent()
        ...
        FoodItem(
            ...
            R.drawable.explore,
            "Breakfast",
            listOf("Large Egg", "Milk", "Salt ", "Pepper"),
            emptyList(),
            listOf("Pan", "Spatula"),
        ...
        FoodItem(
            ...
            "Snack/Dessert",
            listOf("peanut butter", "white sugar", "large egg"),
